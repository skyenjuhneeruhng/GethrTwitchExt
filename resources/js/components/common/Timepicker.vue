<template>
    <span class="time-picker">
        <input class="display-time" :class="inputClass" :readonly="!disabled" :disabled="disabled" :value="displayTime" @click.stop="toggleDropdown" type="text" :placeholder="placeholder" />
...
<script>
    // Modified from Source: https://github.com/phoenixwong/vue2-timepicker
    ...
    export default {
        ...
        computed: {
            displayTime () {
                ...
                if (this.value[this.hourType] == '' && this.value[this.minuteType] == '') {
                    return '';
                }
